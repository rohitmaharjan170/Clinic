          ...
          <div class="left_col scroll-view">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <li><a><i class="fas fa-sitemap"></i> @lang('admin_menu.shareholders') <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{url('shareholders')}}">@lang('admin_menu.shareholders')</a></li>
                    </ul>
                  </li>
                  ...
                  <li><a><i class="fa fa-user-md"></i> @lang('admin_menu.doctor') <span class="fa fa-chevron-down"></span></a>
                   ...
                   <li><a><i class="fa fa-user-md"></i> @lang('admin_menu.member') <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{route('member.create')}}">@lang('admin_menu.add_member')</a></li>
                      <li><a href="{{url('member')}}">@lang('admin_menu.member_list')</a></li>
                    </ul>
                  </li>
