...
<div class="card" style="width: 18rem;">
  <img src="{{ $item->mem_img}}" class="card-img-top" alt="..." style="height:250px; width:100%; object-fit: cover;">
  <div class="card-body">
    <h5 class="card-title">{{ $item->mem_name }}</h5>
    <h6 class="card-text">Phone: {{ $item->mem_phone }}</h6>
    <h6 class="card-text">Department: @php $data=collect($dept)->where('dept_id', $item->mem_dept_id)->first(); @endphp
                          {{ $data->dept_name }}</h6>
    <h6 class="card-text">Post: {{ $item->mem_post }}</h6>
