    ...
    @foreach($data as $value)
        <tr>
            ...
            <td>
                ...
                <button class="delete btn btn-outline-danger btn-sm" data="{{ $value->sh_id }}" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"></i></button>
            </td>
        </tr>
    @endforeach
    </tbody>
