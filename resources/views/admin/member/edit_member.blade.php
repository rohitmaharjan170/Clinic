            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left" method="POST" action="{{route('member.update', $member->mem_id)}}" enctype="multipart/form-data">
                            @method("PUT")
                            @csrf
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input id="name" class="form-control" name="mem_name" placeholder="Enter Name" type="text" value="{{ $member->mem_name }}">
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="text" id="number" name="mem_phone" placeholder="Enter Your Number" class="form-control" value="{{ $member->mem_phone }}">
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="text" id="address" name="mem_address" placeholder="Enter Address" class="form-control" value="{{ $member->mem_address }}">
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input id="profile" type="text" name="mem_post" class="form-control" placeholder="Enter Profile" value="{{ $member->mem_post }}">
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <select class="form-control" name="mem_dept_id">
                                        ...
                                        <option value="{{ $value->dept_id }}" {{ $member->mem_dept_id==$value->dept_id ? 'selected' : '' }}>{{ $value->dept_name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <img id='previmage' style="height:140px;" src="{{asset($member->mem_img)}}" alt="your image" class='img-responsive img-circle'>
                                    <br>
                                    <input type="file" id="image" name="mem_img" onchange="readURL(this);" value="{{ $member->mem_img }}">
