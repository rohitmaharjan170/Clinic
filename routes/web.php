...
Route::get('/onlinepay', 'MasterController@onlinepay');
Route::get('/contact', 'MasterController@contact');
// Route::get('/bod', 'MasterController@bod');
Route::get('/showdoctors', 'MasterController@showdoctors');
Route::get('/showmembers', 'MasterController@showmembers');
// Route::get('/gallery', 'MasterController@gallery');

Route::get('/showshareholders', 'MasterController@shareholders');
